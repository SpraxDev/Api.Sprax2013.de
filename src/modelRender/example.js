var context = require("./modelRender");
var sharp = require("sharp");

var width = 600;
var height = 960;

var camera = context.createCamera(width, height);
...
var no2ndLayer = context.createModel('no2ndLayer.obj', 64, 64);
var with2ndLayer = context.createModel('with2ndLayer.obj', 64, 64);
